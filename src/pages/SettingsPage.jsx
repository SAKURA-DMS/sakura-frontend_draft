...
export default function SettingsPage() {
  ...
  const { currentUser, setTwoFactorEnabled } =
    useApp();
  ...
  const [enabling2FA, setEnabling2FA] =
    useState(false);
  ...
  const handleToggle2FA = (v) => {
    if (v) {
      ...
      toast({
        ...
        description: "2FA telah dimatikan.",
      });
    }
  };
  ...
  const handleVerify = () => {
    ...
    toast({
      ...
      description:
        "Email OTP telah diaktifkan sebagai metode 2FA.",
    });
  };
          ...
          >
            <div className="space-y-1 divide-y divide-border">
              ...
              <Toggle
                ...
                checked={
                  settings.notifications.approve
                }
                onChange={(v) =>
                  updateNotifications({
                    approve: v,
                  ...
                  <div className="p-4 rounded-xl border-2 border-primary bg-primary/[0.04] space-y-3">
                    ...
                    {!otpSent ? (
                      <button
                        ...
                        className="w-full py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold flex items-center justify-center gap-2"
                      >
                        <Mail size={16} />
                        Kirim OTP ke Email
                      </button>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-3 py-2 rounded-lg border border-input text-xs hover:bg-muted"
                          >
                            Kirim ulang
                          </button>
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 py-2 rounded-lg border border-input text-sm"
                          >
                            Batal
                          </button>
                        </div>
