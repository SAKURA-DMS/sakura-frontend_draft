      ...
      <div className="px-3 pt-5 pb-3">
        {collapsed ? (
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            >
              <div className="text-primary font-semibold text-sm tracking-wider">
                SAKURA
              </div>

              <div className="text-sidebar-foreground/50 text-[10px] font-medium">
                Document Management
              </div>
            </button>
      ...
      >
        ...
        >
          <button
            ...
            className={`w-full flex items-center gap-2.5 px-3 py-1.5 text-xs rounded-lg ${
              location.pathname ===
              "/dashboard"
          ...
          {showApproval && (
            <div className="mt-1">
              ...
              <div
                className="pl-6 space-y-0.5 mt-0.5"
                style={{
                  display:
                    approvalSubOpen
                      ? "block"
              ...
              >
                <button
                  ...
                  className={`w-full flex items-center justify-between px-2 py-1.5 text-[11px] rounded-lg ${
                    location.pathname ===
                    "/approval/pending"
                      ? "text-primary font-semibold"
                ...
                >
                  ...
                  {pendingCount >
                    0 && (
                    <span className="bg-primary text-white px-1.5 rounded-full">
                      {
                        pendingCount
                      }
                    </span>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-2 py-1.5 text-[11px] rounded-lg ${
                    location.pathname ===
                    "/approval/approved"
                      ? "text-primary font-semibold"
                      : "text-sidebar-foreground/60 hover:text-primary"
